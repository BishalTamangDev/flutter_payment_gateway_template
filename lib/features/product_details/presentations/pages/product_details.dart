...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  final List<Map<String, dynamic>> paymentGateways = [
    ...
    {'name': 'FonePay', 'image': 'fone_pay.png'},
    {'name': 'ConnectIPS', 'image': 'connect_ips.png'},
    {'name': 'ime_pay', 'image': 'ime_pay.png'},
  ];
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () async {
                                    if (paymentGateways[index]['name']
                                            .toString()
                                            .toLowerCase() ==
                                        'esewa') {
                                      final EsewaService service =
                                          EsewaService();
                                      final bool response = await service.pay(
                                        widget.product,
                                        '123',
                                      );
                                      if (!context.mounted) return;

                                      debugPrint("FINAL RESULT :: $response");
                                  ...
                                  child: Card(
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            "assets/logos/${paymentGateways[index]['image']}",
                                            width: 50.0,
                                            height: 50.0,
                                          ),
